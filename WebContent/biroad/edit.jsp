...
<%
	...
	String boardText = (String) request.getAttribute("boardText");
	String boardTitle = (String) request.getAttribute("boardTitle");
	int boardId = Integer.parseInt((String) request
			...
			<div class="formStruct">
				<div class="container">
					...
					<form action="biroad_control.jsp" name=form3 id="writeForm" method="POST" class="form-horizontal">
						<input type=hidden name="action" value="editBoard">
						<div class="row">
							<input type=hidden name="boardId" value="<%=boardId%>"> <input type=hidden name="boardRoad" value="<%=boardRoad%>"> <input
								type=hidden name="image" value="<%=fileName%>">
							<div class="col-md-1 ">
								<h5>Category</h5>
							</div>
							<div class="col-md-6">
						...
						<br>
						<div class="row">
							<input type=hidden name="boardMemb" value="<%=mem.getMemberId()%>">
							<div class="col-md-1">
								<h5>글쓴이</h5>
							</div>
							<div class="col-md-6">
								<h5><%=mem.getMemberId()%></h5>
							</div>
							<div class="col-md-5"></div>
						</div>
						<br>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<input type="text" name="boardTitle" class="form-control" placeholder="제목을 입력하세요." autocomplete="off" value="<%=boardTitle%>">
							</div>
							<div class="col-md-5"></div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col-md-6">
								<input type="password" name="boardPass" placeholder="게시물 비밀번호를 입력하세요." class="form-control">
							</div>
							<div class="col-md-5"></div>
						</div>
						<br>
						...
						<div class="row">
							...
							<div class="col-md-1">
								<input onclick="writeCheck()" type="button" class="btn btn-primary" value="수정">
							</div>
							<div class="col-md-1"></div>
						</div>
					</form>
