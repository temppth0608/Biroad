...
<script type="text/javascript">
	...
	var lonlat2 = new Tmap.LonLat(126.68014734789062, 37.41176072487254)
			.transform(pr_4326, pr_3857);
	var lonlat1 = new Tmap.LonLat(126.68984490748954, 37.42238250275035)
			.transform(pr_4326, pr_3857);
...
<body onload="initTmap()">
	<form>
		<input class="btn btn-primary" Type="button" VALUE="돌아가기" onClick="history.go(-1);return true;">
	</form>
	<div id="map_div"></div>
