...
<%
	...
	String id = totalpath.getTotalPathId();
	String name = totalpath.getTotalPathName();
	String diff = totalpath.getTotalPathAvgd();
	String hour = totalpath.getTotalPathThour();
	String text = totalpath.getTotalPathText();
%>
...
<body>
	<div align="center">
		<div align="center">
			<h2>전체도로수정</h2>
			<hr>
			[<a href=admin_main.jsp?mode=2&context=9>되돌아가기</a>]
			<p>
		</div>
		<table>
			<tr>
			...
			<form name=form1 method=post action=biroad_control.jsp>
				<input type=hidden name="action" value="trupdate"> <input
					type=hidden name="totalPathId" value="<%=id%>"> <input
					type=hidden name="totalPathName" value="<%=name%>">
				<tr>
					<td><strong><u>총 시간</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="totalPathThour" value="<%=hour%>"></td>
				</tr>
				<tr>
					<td><strong><u>평균 난이도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="totalPathAvgd" value="<%=diff%>"></td>
				</tr>
				<tr>
					<td><strong><u>시작지점</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="totalPathStart"
						value="<%=start%>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="text" name="totalPathEnd" value="<%=end%>"></td>
				</tr>
				<tr>
					<td><strong><u>시작위도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="totalPathStarX"
						value="<%=starx%>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="text" name="totalPathStarY"
						value="<%=stary%>"></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="text" name="totalPathEndX" value="<%=endx%>"></td>
				</tr>
				<tr>
					<td><strong><u>도착경도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="totalPathEndY" value="<%=endy%>"></td>
				</tr>
				<tr>
					<td><strong><u>도로설명</u></strong></td>
					<td><textarea name="totalPathText" cols="100" rows="13"><%=text%></textarea>
					</td>
				</tr>
