<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="path.*"%>
<jsp:useBean id="path" scope="request" class="path.Path" />
<%
	String starx = path.getPathStarX();
	String stary = path.getPathStarY();
	String endx = path.getPathEndX();
	String endy = path.getPathEndY();
	String start = path.getPathStart();
	String end = path.getPathEnd();
	String id = path.getPathId();
	String name = path.getPathName();
	String diff = path.getPathDiff();
	String hour = path.getPathHour();
	String text = path.getPathText();
	String total = path.getTpathId();
	String base = "";
	
	if(total.equals("path1")) {
		base = "아라자전거길";
	} else if(total.equals("path2")) {
		base = "한강종주자전거길";
	} else if(total.equals("path3")) {
		base = "남한강자전거길";
	} else if(total.equals("path4")) {
		base = "북한강자전거길";
	} else if(total.equals("path5")) {
		base = "세재자전거길";
	} else if(total.equals("path6")) {
		base = "낙동강자전거길";
	} else if(total.equals("path7")) {
		base = "금강자전거길";
	} else if(total.equals("path8")) {
		base = "영산강자전거길";
	} else if(total.equals("path9")) {
		base = "섬진강자전거길";
	} else if(total.equals("path10")) {
		base = "오천자전거길";
	}
/*
	switch (total) {
...
<body>
	<div align="center">
		<div align="center">
			<h2>세부도로수정</h2>
			<hr>
			[<a href=admin_main.jsp?mode=2&context=10>되돌아가기</a>]
			<p>
		</div>
		<table>
			<tr>
				<td><strong><u>기존전체경로</u></strong></td>
						...
						<div id="menu_wrap" class="bg_white">
							<div class="option">
								...
								<form onsubmit="searchPlaces(); return false;">
									키워드 : <input type="text" value="<%=start%>" id="keyword"
										size="15">
			...
			<form name=form1 method=post action=biroad_control.jsp>
				<input type=hidden name="action" value="rupdate"> <input
					type=hidden name="pathId" value="<%=id%>">

				<tr>
					<td><input type=hidden name="tpathId"> <select
						name="PID" id="PID" onchange="comm()">
							<option value="ab" selected="selected">--선택--</option>
				...
				<tr>
					<td><strong><u>도로아이디</u></strong></td>
				</tr>
				<tr>
					<td><%=id%></td>
				</tr>
				<tr>
					<td><strong><u>도로이름</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathName" value="<%=name%>"></td>
				</tr>
				<tr>
					<td><strong><u>시간</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathHour" value="<%=hour%>"></td>
				</tr>
				<tr>
					<td><strong><u>난이도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathDiff" value="<%=diff%>"></td>
				</tr>
				<tr>
					<td><strong><u>시작지점</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathStart" value="<%=start%>"></td>
				</tr>
				<tr>
					<td><strong><u>도착지점</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathEnd" value="<%=end%>"></td>
				</tr>
				<tr>
					<td><strong><u>시작위도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathStarX" value="<%=starx%>"></td>
				</tr>
				<tr>
					<td><strong><u>시작경도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathStarY" value="<%=stary%>"></td>
				</tr>
				<tr>
					<td><strong><u>도착위도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathEndX" value="<%=endx%>"></td>
				</tr>
				<tr>
					<td><strong><u>도착경도</u></strong></td>
				</tr>
				<tr>
					<td><input type="text" name="pathEndY" value="<%=endy%>"></td>
				</tr>
				<tr>
					<td><strong><u>도로설명</u></strong></td>
					<td><textarea name="pathText" cols="100" rows="13"><%=text%></textarea>
					</td>
				</tr>
