...
<%
	...
	if(reqlist == null) {
		list = dao.getBoardDBList3();
	} else {
		list = reqlist;
	}
	Board.setBoardRoad("남한강자전거길");
%>
					...
					<div class="col-md-10">
						<div class="tab">
							<ul class="nav nav-tabs">
								...
								<li role="presentation"><a href="bistory2.jsp">한강종주<br>자전거길</a></li>
								<li role="presentation"class="active"><a href="#">남한강<br>자전거길</a></li>
								...
								<li role="presentation"><a href="bistroy10.jsp">오천<br>자전거길</a></li>
							</ul>
						</div>
					</div>
