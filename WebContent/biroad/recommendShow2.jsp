...
<%
	...
	ArrayList<Path> reqlist = (ArrayList<Path>)request.getAttribute("plist");;
						...
						<div class="row">
							...
							<%
								for(Path path : (ArrayList<Path>)list) {
									String tpName = dao.getTotalPathName(path.getPathId());
							%>
							<div class="col-md-4">
									...
									<div class="rec_ran_image">
										...
										<div align="center">
											<form action="biroad_control.jsp" name=form2 method="post" class="form-horizontal">
												...
												<input type=hidden name="pathId" value="<%=path.getPathId() %>">
												<input type=hidden name="tPathId" value="<%=path.getTpathId() %>">
												<div class="row">
													<div class="rec_go">
